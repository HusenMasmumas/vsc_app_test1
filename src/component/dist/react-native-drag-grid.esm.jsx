...
import { Animated, TouchableWithoutFeedback, StyleSheet, PanResponder } from 'react-native';
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    return createElement(Animated.View, Object.assign({
      style: [styles.blockContainer, this.props.style, this.props.dragStartAnimationStyle]
    }, this.props.panHandlers), createElement(Animated.View, null, createElement(TouchableWithoutFeedback, {
  ...
  function DraggableGrid(props) {
    ...
    _this.addItem = function (item, index) {
      ...
      _this.items.push({
        key: item.key,
        itemData: item,
        currentPosition: new Animated.ValueXY(_this.getBlockPositionByOrder(index))
      });
    };
    ...
    _this.startDragStartAnimation = function () {
      if (!_this.props.dragStartAnimation) {
        ...
        Animated.timing(_this.state.dragStartAnimatedValue, {
          toValue: 1.1,
          duration: 100,
    ...
    _this.moveBlockToBlockOrderPosition = function (itemKey) {
      ...
      Animated.timing(_this.items[itemIndex].currentPosition, {
...
//# sourceMappingURL=react-native-drag-grid.esm.js.map
